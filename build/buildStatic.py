...
def main():
    ...
    for filename in posts:
        ...
        outputFilename = os.path.join("output", filename.replace(".control", ".html").replace("static/",""))
        ...
        out.close()
        print "Built static page " + outputFilename + " (%(s)d bytes)" % {'s': os.stat(outputFilename).st_size}
